...
export const IntroScene: React.FC = () => {
  ...
  return <AbsoluteFill style={{background: palette.bg, overflow: 'hidden'}}>
    ...
    <div style={{position: 'absolute', inset: 0, opacity: reveal, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 30, textAlign: 'center'}}>
      ...
      <div style={{fontSize: 78, lineHeight: 1.05, letterSpacing: -3.8, fontWeight: 700, maxWidth: 1200}}>
        ...
        <span style={{color: palette.gold}}>Für diese Bewerbung wollte ich es lieber zeigen.</span>
      </div>
    </div>

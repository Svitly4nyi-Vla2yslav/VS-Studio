...
`;L.div`
  ...
  min-height: 346px;
  z-index: 1;
  animation: ${zN} 12.6s ease-in-out infinite;
...
`;L.div`
  ...
  animation: ${ON} ${({$duration:e})=>`${e}s`} ease-in-out infinite;
  animation-delay: ${({$delay:e})=>`${e}s`};
  pointer-events: none;
  opacity: 0.44;
  ...
  &::before {
    ...
    transform: translateY(-50%);
    animation: ${DN} ${({$duration:e})=>`${Math.max(e-.4,1.2)}s`} linear infinite;
...
`;L.div`
  ...
  &::before {
    ...
    animation: ${PN} ${({$duration:e})=>`${e}s`} ease-out infinite;
    animation-delay: ${({$delay:e})=>`${e}s`};
  }
  ...
  &::after {
    ...
    animation: ${NN} ${({$duration:e})=>`${Math.max(e-.4,1.1)}s`} ease-in-out infinite;
...
`;L.div`
  ...
  box-shadow:
    ...
    inset 0 1px 0 rgba(255, 255, 255, 0.05);
  animation: ${VN} ${({$duration:e})=>`${e}s`} cubic-bezier(0.42, 0.08, 0.58, 0.92) infinite alternate both;
  animation-delay: ${({$delay:e})=>`${e}s`};
  will-change: transform, opacity;
...
`;L.span`
  ...
  animation: ${BN} 2.4s ease-in-out infinite;
`;L.div`
  display: grid;
  gap: 3px;
`;L.strong`
...
`;L.div`
  ...
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.03);
  animation: ${aV} 6.2s ease-in-out infinite;
  will-change: transform;
  ...
  &::before {
    ...
    animation: ${iV} 3.4s ease-in-out infinite;
    pointer-events: none;
  }
`;L.div`
  display: grid;
...
`;L.div`
  ...
  width: max-content;
  transform: translate3d(calc(-50% - (var(--lane-gap) / 2)), 0, 0);
  animation: ${nV} ${({$duration:e})=>`${e}s`} linear infinite;
  animation-delay: ${({$delay:e})=>`${e}s`};
  will-change: transform;
`;L.div`
  display: flex;
...
`;L.div`
  ...
  box-shadow:
    ...
    inset 0 1px 0 rgba(255, 255, 255, 0.04);
  animation: ${oV} 3.6s ease-in-out infinite;
...
`;L.div`
  ...
  box-shadow:
    inset 0 1px 0 rgba(255, 255, 255, 0.04),
    0 24px 56px rgba(3, 9, 20, 0.24);
  animation: ${rV} 8.6s ease-in-out infinite;
...
`;L.div`
  ...
  border: 1px solid rgba(255, 255, 255, 0.08);
  background: rgba(255, 255, 255, 0.04);
  animation: ${sV} 3.8s ease-in-out infinite;
  animation-delay: ${({$delay:e})=>`${e}s`};
`;L.strong`
...
`;L.span`
  ...
  font-size: 12px;
  line-height: 1.35;
`;const Si={eyebrow:"Lead Flow",title:"Website, Ads und Calls gehen direkt in den CRM-Flow.",lanes:[{source:"Website",target:"Lead",tone:"gold"},{source:"Ads",target:"Lead",tone:"blue"},{source:"Calls",target:"Lead",tone:"green"}],routerEyebrow:"CRM Hub",routerTitle:"CRM Router",routerMeta:"Capture, Routing und Rueckmeldung.",miniMeta:["1-2h Antwort","Live in CRM"],stats:[{value:"1-2h",label:"Response"},{value:"Live",label:"Assigned in CRM"}]},lV=()=>{const{t:e}=Ue();return d.jsxs(_N,{"aria-hidden":"true",children:[d.jsx($N,{}),d.jsx(HN,{}),d.jsxs(GN,{children:[d.jsx(UN,{children:e("contact.visual.eyebrow",{defaultValue:Si.eyebrow})}),d.jsx(IN,{children:e("contact.visual.title",{defaultValue:Si.title})})]}),d.jsxs(qN,{children:[d.jsx(FN,{children:Si.lanes.map((t,i)=>d.jsxs(KN,{children:[d.jsx(wv,{$tone:t.tone,children:e(`contact.visual.lanes.${i}.source`,{defaultValue:t.source})}),d.jsx(YN,{}),d.jsx(wv,{children:e(`contact.visual.lanes.${i}.target`,{defaultValue:t.target})})]},t.source))}),d.jsxs(XN,{children:[d.jsx(QN,{children:e("contact.visual.routerEyebrow",{defaultValue:Si.routerEyebrow})}),d.jsx(WN,{children:e("contact.visual.routerTitle",{defaultValue:Si.routerTitle})}),d.jsx(ZN,{children:e("contact.visual.routerMeta",{defaultValue:Si.routerMeta})}),d.jsxs(JN,{children:[d.jsxs(Sv,{children:[d.jsx(I4,{}),e("contact.visual.miniMeta.0",{defaultValue:Si.miniMeta[0]})]}),d.jsxs(Sv,{children:[d.jsx(Ha,{}),e("contact.visual.miniMeta.1",{defaultValue:Si.miniMeta[1]})]})]}),d.jsx(eV,{children:Si.stats.map((t,i)=>d.jsxs(tV,{children:[d.jsx("strong",{children:e(`contact.visual.stats.${i}.value`,{defaultValue:t.value})}),d.jsx("span",{children:e(`contact.visual.stats.${i}.label`,{defaultValue:t.label})})]},t.label))})]})]})]})},jv={hidden:{opacity:0,y:20},show:{opacity:1,y:0}},He={headline:"Erzaehlen Sie uns von Ihrem Projekt",responseTime:"Durchschnittliche Antwortzeit: 1-2h",subtitle:"Kurz beschreiben, was Sie planen. Sie erhalten schnell eine Ersteinschaetzung und den naechsten Schritt.",quickContacts:"Direkter Kontakt",responseNote:"Antwort meist innerhalb von 1-2 Stunden",formTitle:"Projektanfrage",formIntro:"Drei Angaben reichen fuer den Start.",formHelp:"Name, Unternehmen und Ziel genuegen.",nextStepsTitle:"So geht es weiter",nextStepsLead:"Nach Ihrer Anfrage sehen Sie sofort, wie der erste Kontakt, die Priorisierung und die Rueckmeldung organisiert sind.",labels:{name:"Ihr Name",business:"Unternehmen",message:"Projekt oder Ziel"},contactMeta:{location:"Standort fuer schnelle Abstimmung",email:"Projektanfragen per E-Mail",phone:"Kurzes Erstgespraech oder Rueckruf"},trustItems:["Direkte Kommunikation","Klare Ersteinschaetzung","Schnelle Rueckmeldung"],nextSteps:["Ihre Anfrage landet direkt im Intake-Flow.","Wir melden uns meist innerhalb von 1-2 Stunden zurueck.","Sie erhalten einen klaren naechsten Schritt statt langer Rueckfragen."]},cV=()=>{var g;const{t:e}=Ue(),i=((g=ai().state)==null?void 0:g.prefillNeed)||"",[a,o]=E.useState(""),[l,u]=E.useState(""),[f,p]=E.useState(i);E.useEffect(()=>{i&&p(i)},[i]);const m=x=>{x.preventDefault();const y=e("contact.form.title",{defaultValue:He.formTitle}),v=l.trim()?` - ${l.trim()}`:"",S=[`${e("contact.form.labels.name",{defaultValue:He.labels.name})}: ${a.trim()||"-"}`,`${e("contact.form.labels.business",{defaultValue:He.labels.business})}: ${l.trim()||"-"}`,`${e("contact.form.labels.message",{defaultValue:He.labels.message})}:`,f.trim()||"-"].join(`
`);window.location.href=`mailto:kontakt@vs-web-studio.de?subject=${encodeURIComponent(`${y}${v}`)}&body=${encodeURIComponent(S)}`};return d.jsx(aN,{children:d.jsxs(pn,{children:[d.jsx(rN,{as:ae.section,initial:"hidden",animate:"show",variants:jv,transition:{duration:.62,ease:dn},children:d.jsx(sN,{children:d.jsxs(oN,{children:[d.jsxs(lN,{children:[d.jsxs(dN,{children:[d.jsx(Gu,{}),d.jsx("span",{children:e("contact.responseTime",{defaultValue:He.responseTime})})]}),d.jsx(fN,{children:d.jsx(Ua,{text:e("contact.h1",{defaultValue:He.headline}),durationMs:2200,storageKey:"kontakt_h1_once"})}),d.jsx(pN,{children:e("contact.subtitle",{defaultValue:He.subtitle})})]}),d.jsxs(cN,{children:[d.jsxs(hN,{onSubmit:m,noValidate:!0,children:[d.jsx(fm,{children:"VS Web Studio"}),d.jsx(yv,{children:e("contact.form.title",{defaultValue:He.formTitle})}),d.jsx(mN,{children:e("contact.form.intro",{defaultValue:He.formIntro})}),d.jsxs(fh,{children:[d.jsx(ph,{children:e("contact.form.labels.name",{defaultValue:He.labels.name})}),d.jsxs(hh,{children:[d.jsx(nA,{}),d.jsx("input",{type:"text",name:"name",value:a,onChange:x=>o(x.target.value),placeholder:e("contact.form.name",{defaultValue:He.labels.name}),"aria-label":e("contact.form.labels.name",{defaultValue:He.labels.name}),required:!0})]})]}),d.jsxs(fh,{children:[d.jsx(ph,{children:e("contact.form.labels.business",{defaultValue:He.labels.business})}),d.jsxs(hh,{children:[d.jsx(U4,{}),d.jsx("input",{type:"text",name:"business",value:l,onChange:x=>u(x.target.value),placeholder:e("contact.form.business",{defaultValue:He.labels.business}),"aria-label":e("contact.form.labels.business",{defaultValue:He.labels.business}),required:!0})]})]}),d.jsxs(fh,{children:[d.jsx(ph,{children:e("contact.form.labels.message",{defaultValue:He.labels.message})}),d.jsxs(hh,{children:[d.jsx(UC,{}),d.jsx("textarea",{name:"message",placeholder:e("contact.form.need",{defaultValue:He.labels.message}),value:f,onChange:x=>p(x.target.value),"aria-label":e("contact.form.labels.message",{defaultValue:He.labels.message}),required:!0})]})]}),d.jsx(gN,{children:e("contact.form.help",{defaultValue:He.formHelp})}),d.jsxs(bN,{type:"submit",children:[d.jsx(Ha,{}),e("contact.form.submit",{defaultValue:"Projekt anfragen"})]})]}),d.jsx(uN,{children:d.jsx(lV,{})})]})]})})}),d.jsx(TN,{as:ae.section,initial:"hidden",whileInView:"show",viewport:{once:!0,amount:.18},variants:jv,transition:{duration:.52,ease:dn},children:d.jsxs(jN,{children:[d.jsxs(xv,{children:[d.jsx(fm,{children:"VS Web Studio"}),d.jsx(yv,{children:e("contact.quickContacts",{defaultValue:He.quickContacts})}),d.jsxs(xN,{children:[d.jsx(aA,{}),d.jsx("span",{children:e("contact.responseNote",{defaultValue:He.responseNote})})]}),d.jsxs(yN,{children:[d.jsxs(vN,{children:[d.jsx(Do,{}),d.jsxs("div",{children:[d.jsx("strong",{children:"Hildesheim"}),d.jsx("span",{children:e("contact.contactMeta.location",{defaultValue:He.contactMeta.location})})]})]}),d.jsxs(vv,{href:"mailto:kontakt@vs-web-studio.de",children:[d.jsx(Ha,{}),d.jsxs("div",{children:[d.jsx("strong",{children:"kontakt@vs-web-studio.de"}),d.jsx("span",{children:e("contact.contactMeta.email",{defaultValue:He.contactMeta.email})})]})]}),d.jsxs(vv,{href:"tel:+49301234567",children:[d.jsx(XC,{}),d.jsxs("div",{children:[d.jsx("strong",{children:"+49 30 1234567"}),d.jsx("span",{children:e("contact.contactMeta.phone",{defaultValue:He.contactMeta.phone})})]})]})]}),d.jsx(wN,{children:He.trustItems.map((x,y)=>d.jsxs(SN,{children:[d.jsx(Tt,{}),e(`contact.trustItems.${y}`,{defaultValue:x})]},x))})]}),d.jsxs(xv,{children:[d.jsx(kN,{children:e("contact.nextStepsEyebrow",{defaultValue:"Lead Intake"})}),d.jsx(EN,{children:e("contact.nextStepsTitle",{defaultValue:He.nextStepsTitle})}),d.jsx(CN,{children:e("contact.nextStepsLead",{defaultValue:He.nextStepsLead})}),d.jsx(AN,{children:He.nextSteps.map((x,y)=>d.jsxs(MN,{children:[d.jsxs("span",{children:["0",y+1]}),d.jsx("p",{children:e(`contact.nextSteps.${y}`,{defaultValue:x})})]},x))})]})]})})]})})},uV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsxs(pn,{children:[d.jsxs(ri,{children:[d.jsx("h1",{children:d.jsx(Ua,{text:e("blog.h1"),durationMs:2600,storageKey:"blog_h1_once"})}),d.jsx("p",{children:e("blog.subtitle")})]}),d.jsx(ht,{children:d.jsxs(xg,{children:[d.jsx(Ge,{children:d.jsxs("h3",{children:[d.jsx(Ft,{children:d.jsx(Wr,{})}),e("blog.cards.c1")]})}),d.jsx(Ge,{children:d.jsxs("h3",{children:[d.jsx(Ft,{children:d.jsx(Y4,{})}),e("blog.cards.c2")]})}),d.jsx(Ge,{children:d.jsxs("h3",{children:[d.jsx(Ft,{children:d.jsx(ll,{})}),e("blog.cards.c3")]})}),d.jsx(Ge,{children:d.jsxs("h3",{children:[d.jsx(Ft,{children:d.jsx(Wr,{})}),e("blog.cards.c4")]})})]})}),d.jsxs(yg,{children:[d.jsx("h2",{children:d.jsx(Ua,{text:e("blog.leadMagnet"),durationMs:1800,storageKey:"blog_leadmagnet_once"})}),d.jsxs(vD,{style:{maxWidth:420},children:[d.jsxs(i3,{children:[d.jsx(Ha,{})," ",d.jsx("input",{type:"email",placeholder:e("blog.emailPlaceholder"),required:!0})]}),d.jsxs(n3,{type:"submit",children:[d.jsx(Ha,{})," ",e("blog.getGuide")]})]})]})]})})},dV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsxs(pn,{children:[d.jsxs(ri,{children:[d.jsx("h1",{children:e("legal.impressum.h1")}),d.jsx("p",{children:e("legal.impressum.subtitle")})]}),d.jsx(ht,{children:d.jsxs(Ge,{children:[d.jsx("p",{children:e("legal.impressum.l1")}),d.jsx("p",{children:e("legal.impressum.l2")}),d.jsx("p",{children:e("legal.impressum.l3")}),d.jsx("p",{children:e("legal.impressum.l4")}),d.jsx("p",{children:e("legal.impressum.l5")})]})})]})})},fV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsxs(pn,{children:[d.jsxs(ri,{children:[d.jsx("h1",{children:e("legal.datenschutz.h1")}),d.jsx("p",{children:e("legal.datenschutz.subtitle")})]}),d.jsx(ht,{children:d.jsxs(Ge,{children:[d.jsx("p",{children:e("legal.datenschutz.l1")}),d.jsx("p",{children:e("legal.datenschutz.l2")}),d.jsx("p",{children:e("legal.datenschutz.l3")}),d.jsx("p",{children:e("legal.datenschutz.l4")})]})})]})})},pV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsxs(pn,{children:[d.jsxs(ri,{children:[d.jsx("h1",{children:e("legal.agb.h1")}),d.jsx("p",{children:e("legal.agb.subtitle")})]}),d.jsx(ht,{children:d.jsxs(Ge,{children:[d.jsx("p",{children:e("legal.agb.l1")}),d.jsx("p",{children:e("legal.agb.l2")})]})})]})})},hV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsxs(pn,{children:[d.jsxs(ri,{children:[d.jsx("h1",{children:e("legal.cookies.h1")}),d.jsx("p",{children:e("legal.cookies.subtitle")})]}),d.jsx(ht,{children:d.jsxs(Ge,{children:[d.jsx("p",{children:e("legal.cookies.l1")}),d.jsx("p",{children:e("legal.cookies.l2")})]})})]})})},mV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsx(pn,{children:d.jsxs(ri,{children:[d.jsx("h1",{children:e("niche.handwerker.h1")}),d.jsx("p",{children:e("niche.handwerker.p")}),d.jsx(sa,{children:d.jsx(oa,{to:"/kontakt",children:e("common.projectRequest")})})]})})})},gV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsx(pn,{children:d.jsxs(ri,{children:[d.jsx("h1",{children:e("niche.praxis.h1")}),d.jsx("p",{children:e("niche.praxis.p")}),d.jsx(sa,{children:d.jsx(oa,{to:"/kontakt",children:e("common.projectRequest")})})]})})})},bV=()=>{const{t:e}=Ue();return d.jsx(Cn,{children:d.jsx(pn,{children:d.jsxs(ri,{children:[d.jsx("h1",{children:e("niche.werkstatt.h1")}),d.jsx("p",{children:e("niche.werkstatt.p")}),d.jsx(sa,{children:d.jsx(oa,{to:"/kontakt",children:e("common.projectRequest")})})]})})})},xV=()=>d.jsx(KS,{children:d.jsxs(wt,{path:"/",element:d.jsx(nR,{}),children:[d.jsx(wt,{index:!0,element:d.jsx(oD,{})}),d.jsx(wt,{path:"services",element:d.jsx(dP,{})}),d.jsx(wt,{path:"preise",element:d.jsx(GP,{})}),d.jsx(wt,{path:"referenzen",element:d.jsx(WP,{})}),d.jsx(wt,{path:"ueber-uns",element:d.jsx(iN,{})}),d.jsx(wt,{path:"kontakt",element:d.jsx(cV,{})}),d.jsx(wt,{path:"blog",element:d.jsx(uV,{})}),d.jsx(wt,{path:"handwerker",element:d.jsx(mV,{})}),d.jsx(wt,{path:"praxis",element:d.jsx(gV,{})}),d.jsx(wt,{path:"werkstatt",element:d.jsx(bV,{})}),d.jsx(wt,{path:"impressum",element:d.jsx(dV,{})}),d.jsx(wt,{path:"datenschutz",element:d.jsx(fV,{})}),d.jsx(wt,{path:"agb",element:d.jsx(pV,{})}),d.jsx(wt,{path:"cookies",element:d.jsx(hV,{})}),d.jsx(wt,{path:"home",element:d.jsx(Ab,{to:"/",replace:!0})}),d.jsx(wt,{path:"*",element:d.jsx(Ab,{to:"/",replace:!0})})]})});K8.createRoot(document.getElementById("root")).render(d.jsxs(Ce.StrictMode,{children:[d.jsx(yT,{styles:kT}),d.jsx(b9,{basename:"/",children:d.jsx(bM,{children:d.jsx(xV,{})})})]}));export{yV as c,kv as g};

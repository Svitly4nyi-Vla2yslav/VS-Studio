...
import { OvenRepairs } from '../../components/OvenRepair/OvenRepair';
import Professional from '../../components/OvenRepair/Professional';
import OvenTypes from '../../components/OvenRepair/OvenTypes';

const OvenRepair: React.FC = () => {
  return (
    <Container id='ap'>
      <OvenRepairs />
      <Partners />

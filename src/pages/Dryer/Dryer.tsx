...
import { DryerRepair } from '../../components/Dryer/DryerRepair';
import Partners from '../../components/PartnersBanner/PartnersBanner';
import Professional from '../../components/Dryer/Professional';
...
import DryerTypes from '../../components/Dryer/DryerTypes';

const Dryer: React.FC = () => {
  return (
    <Container id='ap'>
      <DryerRepair />
      <Partners />

...
const systemsUk: Record<SystemKey, SystemData> = {
  website: {
    ...
    system: 'Landing або multi-page сайт з GA4, Meta Pixel, server-side tracking, CRM та DSGVO-базою.',
    outcome: 'Кожен лід фіксується і чітко прив’язується до каналу.',
    kpis: ['Якість трекінгу', 'Form Completion', 'Lead Source Clarity'],
    details: ['Коректно налаштований Consent Mode', 'Call і WhatsApp події', 'CRM push у реальному часі'],
  },
  ai: {
    title: 'AI Qualification Layer',
    icon: <FaRobot />,
    problem: 'Надто багато нецільових звернень перевантажують продажі й телефонну лінію.',
    system: 'AI-чатбот, автокваліфікація, DM-flow у WhatsApp/Instagram, email-автоматизація та lead scoring.',
  ...
  ads: {
    ...
    outcome: 'Бюджет іде в кампанії з кращою якістю лідів, а не просто в кліки.',
    kpis: ['Cost per Qualified Lead', 'ROAS by Campaign', 'Creative Win Rate'],
  ...
  analytics: {
    title: 'Control Analytics',
    icon: <FaChartLine />,
    problem: 'Рішення приймаються за скріншотами платформ, а не за даними воронки.',
    ...
    kpis: ['Lead to Appointment', 'Lead to Deal', 'Pipeline Velocity'],
    details: ['Сегментація за регіоном і послугою', 'Алерти при просіданні funnel', 'Щомісячний backlog гіпотез'],
  },
};
...
const timelineStepsUk: readonly TimelineStep[] = [
  ...
  ['04', 'Запуск', 'Робимо QA трекінгу, запускаємо кампанії та CRM-flow.'],
  ['05', 'Оптимізація', 'Щотижнево тестуємо креативи, воронку та логіку кваліфікації.'],
  ['06', 'Масштабування', 'Робочі зв’язки переносимо на нові регіони й послуги.'],
] as const;
